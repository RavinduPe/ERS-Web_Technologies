...
$query = "SELECT * FROM `exam_stud_index` WHERE `regNo`= '$regNo'";
    ...
    <nav class="w-full h-[15vh] min-h-fit drop-shadow-md bg-white fixed top-0 left-0">
        <div class="w-10/12 h-full m-auto flex items-center justify-between">
            ...
            <ul class="flex flex-row items-center space-x-4">
                ...
                <?php } else { ?>
                    <li>
                        <label for="languageSwitcher" class="block text-lg font-semibold mb-2 text-gray-700 hover:text-blue-700 transition duration-300 ease-in-out">Choose Language:</label>
                        <select id="languageSwitcher" class="block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring focus:ring-blue-500 focus:border-blue-500 hover:border-blue-700 transition duration-300 ease-in-out">
        ...
        <div class="card ">
            <div class="w-11/12 mx-auto h-fit">
                ...
                function displayStep1() {
                    ...
                    ?>
                    <!-- TODO Translation -->
                    <h1 id = "reg_button" class="text-lg font-black text-center underline mt-5 text-gray-800 lg:text-2xl">Exam Registration</h1>
                    ...
                    <div class="instructions mt-7 mb-16">
                        ...
                        <ol class="ml-4 lg:ml-7 my-4 list-decimal text-justify space-y-4">
                            <li id="text06">
                                ...
                                <ul class="ml-4 lg:ml-7 list-decimal text-justify">
                                    <li class="font-semibold" id="text08">Theory and Practical of a course unit - Rs. 250/=</li>
                                    <li class="font-semibold" id="text09">Theory or Practical of a course unit - Rs. 250/=</li>
                                </ul>
                                <br>
                                <b class="font-bold"><u id="text10">NOTE:</u></b><br>
                                <ul class="ml-4 lg:ml-7 my-1 list-decimal text-justify">
                                    <li class="font-semibold" id="text11">Please write the following details in the back side of the Deposit Slip: <br> 1. Full Name  2. Reg. No.   3. Level of Repeat Exam   4. Applied course units</li>
                                    <li class="font-semibold" id="text12">You need to include both sides of the Deposit Slip in a single PDF file and attach that PDF file. (Only one PDF file is allowed)</li>
                                    <li class="font-semibold" id="text13">Original Deposit Slip should be handover to the Dean's office</li>
                                </ul>
                            </li>
                        ...
                        <p class="text-right mt-5" id="text17">Assistant Registrar<br>FACULTY OF SCIENCE</p>
                    </div>
                ...
                function displayStep3() {
                    ...
                    <div class="mx-auto w-11/12">
                        <div class="text-center">
                            <h3 id="psctext01" class="font-bold lg:text-xl text-gray-800">Payment Slip copies</h3>
                            <p id="psctext02" class="text-gray-500 mt-1">Read and understand the following instructions</p>
                            <ol class="ml-4 lg:ml-7 my-4 list-decimal text-justify space-y-4">
                                <li id="psctext03">
                                ...
                                <li>
                                    <b class="font-bold" id="psctext04"><u>NOTE:</u></b><br>
                                    <ul class="ml-4 lg:ml-7 my-1 list-decimal text-justify">
