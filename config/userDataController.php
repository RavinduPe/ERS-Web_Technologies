...
require($_SERVER['DOCUMENT_ROOT'] . '/group2_v2/ERS-Web_Technologies/vendor/autoload.php'); // Include PHPMailer autoloader
require($_SERVER['DOCUMENT_ROOT'] . '/group2_v2/ERS-Web_Technologies/config/connect.php');
