...
include($_SERVER['DOCUMENT_ROOT'] . '/Group 13/ERS-Web_Technologies/config/connect.php');
require($_SERVER['DOCUMENT_ROOT'] . '/Group 13/ERS-Web_Technologies/vendor/autoload.php');
